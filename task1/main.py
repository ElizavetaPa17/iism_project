from utils.files import test_folders_list
...
def main():
    ...
    try:
        ...
        all_genuine_folders = [[folder[0]] for folder in test_folders_list]
        all_forged_folders = [folder[1] if folder[1] is not np.nan else '' for folder in test_folders_list]
